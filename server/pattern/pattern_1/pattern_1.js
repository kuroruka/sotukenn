...
window.onload = function () {    
    ...
    hoge.addEventListener('input', (e) => {
        ...
        Ajax(value_1,value_2,value_3,value_4,value_5,'http://54.248.37.203/file_write/light/file_write_live.php');
...
function clickDisplayAlert() {
    ...
    Ajax(value_1,value_2,value_3,value_4,value_5,'http://54.248.37.203/file_write/light/json_file_write.php')
