...
<body>
    ...
    <div class="box">
        <h2><span class="badge badge-warning">00</span></h2>
    </div>
    <div class="box2">
        <h2><span class="badge badge-warning2">0.00</span></h2>
    </div>
    <div class="box3">
        <h2><span class="badge badge-warning3">000</span></h2>
    </div>
    <div class="box4">
        <h2><span class="badge badge-warning4">000</span></h2>
    </div>
    <div class="box5">
        <h2><span class="badge badge-warning5">000</span></h2>
    </div>

    <div class="box6">
        <h2><span class="badge badge-warning6"><?php echo (int)$fustion_data[0]; ?></span></h2>
    </div>


    <input id="slider" class="range-style" type="range" value="5" min="0" max="60" step="1" />
    <input id="slider2" class="range-style2" type="range" value="0.05" min="0" max="1" step="0.01" />
